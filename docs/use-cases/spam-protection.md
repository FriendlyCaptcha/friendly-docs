...
While Friendly Captcha is effective at blocking automated spam bots, humans may still be able to manually submit spam as Friendly Captcha will never outright block a real human user. While these users will be slowed down by the Friendly Captcha challenge, you can further mitigate spam from humans by implementing additional measures such as content moderation, user reporting, or manual review processes to identify and remove spam content that may slip through the automated defenses.
