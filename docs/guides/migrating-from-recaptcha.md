...
1. Replace the reCAPTCHA script
    ...
    ```html
    <script type="module" src="https://cdn.jsdelivr.net/npm/@friendlycaptcha/sdk@0.1.11/contrib/recaptcha-site.min.js"
            async defer></script>
    <script nomodule src="https://cdn.jsdelivr.net/npm/@friendlycaptcha/sdk@0.1.11/contrib/recaptcha-site.compat.min.js"
          async defer></script>
    ```
