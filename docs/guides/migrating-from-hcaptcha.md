...
1. Replace the hCaptcha script
    ...
    ```html
    <script type="module" src="https://cdn.jsdelivr.net/npm/@friendlycaptcha/sdk@0.1.9/contrib/hcaptcha-site.min.js"
            async defer></script>
    <script nomodule src="https://cdn.jsdelivr.net/npm/@friendlycaptcha/sdk@0.1.9/contrib/hcaptcha-site.compat.min.js"
          async defer></script>
    ```
