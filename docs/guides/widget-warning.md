...
:::info Not the website administrator?

These warnings are **only relevant to the website administrator**.
If you're a visitor trying to use a website that shows a Friendly Captcha widget, you can **ignore the warning** and continue using the site normally. The warning is not related to anything you've done.
