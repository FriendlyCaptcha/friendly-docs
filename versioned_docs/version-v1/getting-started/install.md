...
> Make sure to always import a specific version (e.g. `friendly-challenge@0.9.18`), then you can be sure that the script you import and integrate with your website doesn't change unexpectedly. Also see [**Versioning and Immutability**](/docs/v2/guides/sdk-versioning).
